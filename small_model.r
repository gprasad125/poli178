...
join20 <- join20[!(row.names(join20) %in% c(4,6,11,36,39,45,46)),]
...
join20cname <- join20cname[!(row.names(join20cname) %in% c(4,6,11,36,39,45,46)),]
...
#Generate control conditions pred
